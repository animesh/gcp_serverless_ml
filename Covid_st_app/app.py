...
def main():
    ...
    X_signght   = st.text_input('cough', 0)
    X_symptom    = st.text_input('fever', 0)
    Y_signgth   = st.text_input('sore_throat', 0)
    Y_symptom    = st.text_input('shortness_of_breath', 0)
    Z_symptom    = st.text_input('headache', 0)
